document.addEventListener("DOMContentLoaded", function () {
    ...
    // noinspection JSUnresolvedReference
    const tabsQuery = browser.tabs.query;
    ...
    loginButton.addEventListener("click", function () {
        ...
        if (!email || !password) {
            errorLoginTag.innerHTML = "Please enter both email and password.";
            return;
        }
        ...
        fetch("https://podcastlater.com/api/498b-b5a3/auth", {
            ...
            .catch((error) => {
                ...
                errorLoginTag.textContent = "Login failed. Please check your email, password, and network.";
            });
    });
    ...
    saveButton.addEventListener("click", function () {
        ...
        tabsQuery({active: true, currentWindow: true}).then((tabs) => {
            ...
            storage.get("userToken").then((result) => {
                ...
                // Directly call the save endpoint
    ...
    function doSaveArticle(urlToSave, userToken) {
        fetch("https://podcastlater.com/api/498b-b5a3/save", {
            ...
            .then((res) => res.json())
            .then((data) => {
                // data may be {} if already saved,
                // or { success: true, ... } if newly saved
                if (data.success) {
